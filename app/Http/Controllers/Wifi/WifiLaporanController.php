...
class WifiLaporanController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $pelangganList->transform(function ($item) use ($pembayaranRecords, $referenceDate, &$totalTarikanRealisasi, &$totalHasilBumdes, &$totalHakProvider, &$lunasCount, &$belumBayarCount) {
