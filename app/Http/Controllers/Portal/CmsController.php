...
class CmsController extends Controller
{
    ...
    public function updateProfil(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'org_bumdes_pembina_name' => 'nullable|string|max:255',
            'org_bumdes_pembina_image' => 'nullable|string',
            ...
            'org_bumdes_unit_sp_name' => 'nullable|string|max:255',
            'org_bumdes_unit_sp_image' => 'nullable|string',
            'org_bumdes_unit_wifi_name' => 'nullable|string|max:255',
            'org_bumdes_unit_wifi_image' => 'nullable|string',
            'org_bumdes_unit_pangan_name' => 'nullable|string|max:255',
            'org_bumdes_unit_pangan_image' => 'nullable|string',
            'org_bumdes_unit_pasar_name' => 'nullable|string|max:255',
            'org_bumdes_unit_pasar_image' => 'nullable|string',
