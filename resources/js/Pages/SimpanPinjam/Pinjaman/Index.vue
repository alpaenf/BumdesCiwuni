...
const props = defineProps({ pinjaman: Object, filters: Object });
...
watch([search, status], () => {
    ...
    timeout = setTimeout(() => {
        router.get(route('pinjaman.index'), { search: search.value, status: status.value }, { preserveState: true, replace: true });
    }, 400);
});
        ...
        <div class="space-y-5">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-sm text-[color:var(--color-secondary)]">Total {{ pinjaman.total }} data pinjaman</p>
                </div>
