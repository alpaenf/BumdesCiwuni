        ...
        <header :class="[
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h1 :class="['text-xs font-extrabold leading-tight transition-colors', isScrolled ? 'text-blue-800' : 'text-white']">Simpan Pinjam</h1>
                ...
                <nav class="hidden md:flex items-center gap-5">
                    ...
                    <div :class="['border-l pl-4 flex items-center gap-2 transition-colors', isScrolled ? 'border-[#bfc9bd]' : 'border-white/30']">
                        ...
                        <template v-else>
                            <Link :href="route('login')" :class="['inline-flex items-center justify-center px-4 py-2 font-semibold text-xs rounded-lg transition-colors border', isScrolled ? 'border-blue-600 text-blue-700 hover:bg-blue-50' : 'border-white/50 text-white hover:bg-white/20']">
                                Masuk
                            </Link>
                        </template>
                    </div>
