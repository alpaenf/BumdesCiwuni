            ...
            <div class="rounded-xl border border-[color:var(--color-outline-variant)] bg-white p-6 shadow-sm">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
                        ...
                        <button type="submit" :disabled="form.processing" class="w-full sm:w-auto justify-center flex items-center gap-2 rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:opacity-90 disabled:opacity-60">
