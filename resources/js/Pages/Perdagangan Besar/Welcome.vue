        ...
        <header :class="[
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h1 class="text-xs font-extrabold text-blue-800 leading-tight">Perdagangan Besar</h1>
                ...
                <nav class="hidden md:flex items-center gap-5">
                    ...
                    <div class="border-l border-[#bfc9bd] pl-4 flex items-center gap-2">
                        ...
                        <template v-else>
                            <Link :href="route('unit.login', { slug: 'perdagangan-besar' })" class="inline-flex items-center justify-center px-4 py-2 border border-blue-600 text-blue-700 font-semibold text-xs rounded-lg hover:bg-blue-50 transition">
                                Masuk
                            </Link>
                        </template>
                    </div>
